...
import com.EventHub.eventHub.infrastructure.adapters.in.web.filter.TraceIdFilter;
import com.EventHub.eventHub.infrastructure.security.JwtAuthenticationFilter;
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(
                                ...
                                "/swagger-ui/**",
                                "/v3/api-docs/**",
                                "/actuator/**" // <-- AÑADIDO PARA PERMITIR ACCESO PÚBLICO A ACTUATOR
                        ).permitAll()
